...
#### Riesgo 1 — A03:2025 Inyección de Prompts directa
...
#### Riesgo 2 — A01:2025 Broken Access Control
...
#### Riesgo 3 — A10:2025 Falsificación de Solicitudes del Lado del Servidor / SSRF
...
| Privacidad | Los datos salen a la nube | Privacidad total [^2] |
...
Capa Local (Ollama + Qwen 2.5 Coder o DeepSeek-R1): El chatbot se encarga del 100% de las tareas que involucran PII y datos sensibles (consultar el historial de pedidos, verificar datos de contacto, rastrear fletes con direcciones físicas y procesar los planos o imágenes del hogar). De esta forma se garantiza cumplimiento legal a coste cero [^2].
